...
consumer.subscriptions.create("ColorChannel", {
  connected() {
    streamCoordinator.connectedChange('connected');
  },

  disconnected() {
    streamCoordinator.connectedChange('disconnected');
  },

  received(data) {
    streamCoordinator.processStreamEvent(data);
  }
});

window.streamCoordinator = {
  processingMode: null,
